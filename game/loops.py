...
def menu_basic(
    ...
    if menu_name != "main menu":
        main_menu_button = Button("", (255, 255, 255), 10, 10, "main_menu")
        ...
        if menu_name != "game" and previous_menu in ["settings", "profiles"]:
            back_button = Button("Back", (255, 255, 255), 10, 40, "back")
...
def menu_bottom_nav_buttons(start_index, all_list, click):
    ...
    if start_index > 0:
        previous_button = Button("previous", (255, 255, 255), 10, HEIGHT - 100, "back")
...
def high_score_name_entry(
    ...
    while True:
        ...
        done_button = Button("done", (255, 255, 255), 300, 500, "menu_button")
...
def settings_loop(clock, track, player_car, computer_car, game_info, player_profile):
    ...
    while True:
        ...
        car_button = Button("car", (255, 255, 255), 300, 200, "menu_button")
        if car_button.button_rect.collidepoint(pygame.mouse.get_pos()) and click:
            car_settings(
                clock, track, player_car, computer_car, game_info, player_profile
            )

        track_button = Button("track", (255, 255, 255), 300, 300, "menu_button")
...
def car_settings(clock, track, player_car, computer_car, game_info, player_profile):
    ...
    while True:
        ...
        for item in all_cars:
            ...
            button = Button(item.car_name, (255, 255, 255), 10, y, "menu_button")
...
def track_settings(clock, track, player_car, computer_car, game_info, player_profile):
    ...
    while True:
        ...
        for item in all_tracks:
            ...
            button = Button(item.track_name, (255, 255, 255), 300, y, "menu_button")
...
def profiles_settings(
    ...
    while True:
        ...
        create_profile_button = Button(
            "create profile", (255, 255, 255), 300, 100, "menu_button"
        )
        if (
        ...
        for profile in all_profiles:
            profile_buttons.append(
                Button(profile.username, (255, 255, 255), 300, y, "menu_button")
            )
            y += 100
...
def main_menu(clock, track, player_car, computer_car, game_info, player_profile):
    ...
    while True:
        ...
        play_button = Button("Play", (255, 255, 255), 300, 200, "menu_button")
        if play_button.button_rect.collidepoint(pygame.mouse.get_pos()) and click:
            game_loop(clock, track, player_car, computer_car, game_info, player_profile)

        settings_button = Button("Settings", (255, 255, 255), 300, 300, "menu_button")
        ...
        high_scores_button = Button(
            "High Scores", (255, 255, 255), 300, 400, "menu_button"
        )
        if (
        ...
        profiles_button = Button("profiles", (255, 255, 255), 300, 500, "menu_button")
